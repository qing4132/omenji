...
// 1 个从这里抽（不一定贴题，留出"看似无关却有启发"的空间）。
// 涵盖所有诗自带的词 + 一批额外"野"词。
export const GLOBAL_DO = [
  // —— 与诗常见贴题词
  '静坐', '焚香', '煮茶', '煮酒', '抄经', '写字', '翻书', '抚琴',
  '远眺', '看云', '看月', '看花', '看星', '听雨', '听雪', '听风',
  '散步', '独行', '慢行', '独坐', '闲坐', '午睡', '早睡', '早起',
  '出门', '回家', '关灯', '关窗', '收伞', '开门', '留客', '待客',
  '不语', '不答', '不问', '放下', '独酌', '共饮', '长谈', '大笑',
  '微笑', '点头', '折枝', '收信', '寄信', '吃面',
  // —— 额外"野"词，给惊喜
  '沐浴', '洗手', '剪指甲', '换袜子', '拖地', '擦窗', '拾叶', '插花',
  '晒被', '整理', '翻箱', '吹灯', '点蜡', '闻香', '看雨', '数星',
  '抄手', '走神', '坐窗边', '不打卡', '远看猫', '吃热饭', '把会推掉',
] as const;

export const GLOBAL_DONT = [
  // —— 与诗常见贴题词
  '强求', '复盘', '计较', '揣测', '挽留', '翻旧账', '回头', '动怒',
  '远行', '夜行', '立誓', '抢答', '深谈', '争辩', '问卜', '复读',
  '迟疑', '拖延', '抱怨', '攀附', '应酬', '客套', '推辞', '早归',
  '张扬', '急行', '探听', '追问', '催促', '求人', '求解', '求工',
  '替人决断', '减肥',
  // —— 额外"野"词
  '出言', '表态', '越界', '评人', '自责', '反复', '大声', '回信',
  '点外卖', '查体重', '看朋友圈', '回复甲方', '解释自己', '相信"最后一次"',
  '点开未读', '凌晨刷手机', '主动联系前任', '立 flag', '在群里说话',
] as const;
